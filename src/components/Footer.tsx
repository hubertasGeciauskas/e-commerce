import { Button, Container, Flex, Text, ButtonGroup, Stack, Divider } from "@chakra-ui/react";
...
export function Footer () {
    ...
    return (
        <>
        <Divider border={"1px solid black"} w={"80%"} mx={"auto"} />
